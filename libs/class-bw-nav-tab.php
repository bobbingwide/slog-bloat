...
/**
 * @copyright Bobbing Wide 2014-2017, 2021
 * @package oik-libs ?
 * Class BW_nav_tab
 *
 * Originally implemented as bw_nav_tabs and bw_nav_tab_link in oik/includes/bw-nav-tab.php
 * this is now an autoloadable shared library class.
 * @depends class-BW-
 */
class BW_nav_tab {

	/**
	 * Creates a nav-tab link.
	 *
	 ...
	 */
	static function bw_nav_tab_link( $nav_tab, $nav_label, $page, $tab ) {
	...
	static function bw_nav_tabs( $default_tab=null, $default_label=null ) {
		...
		foreach ( $nav_tabs as $nav_tab=>$nav_label ) {
			self::bw_nav_tab_link( $nav_tab, $nav_label, $page, $tab );
		}
		etag( "h2" );
