...
* Changed: Remove slog-bloat's dependency on slog,https://github.com/bobbingwide/slog-bloat/issues/4

# 0.0.2 
* Changed: Apply slog bloat automatic filters if required,https://github.com/bobbingwide/slog-bloat/issues/3
* Changed: Automatically filter the GET 200 requests in the driver file,https://github.com/bobbingwide/slog-bloat/issues/2

# 0.0.1 
* Changed: Change vt-driver.php default parameters
* Changed: Pass fully qualified driver file name to vt-driver.php
* Changed: Change the Slog-bloat admin to use tabs,https://github.com/bobbingwide/slog-bloat/issues/1
* Changed: Improve filtering by request type. Add filtering for http response code,https://github.com/bobbingwide/slog-bloat/issues/3
* Changed: Improve styling on Slog-bloat admin,https://github.com/bobbingwide/slog-bloat/issues/5
